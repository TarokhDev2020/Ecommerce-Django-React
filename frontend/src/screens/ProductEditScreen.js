                ...
                {loading ? <Loader/> : error ? <Message variant="danger">{error}</Message> : (
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId="brand">
                            ...
                            <Form.Control type="name" placeholder="Enter Brand" value={brand} onChange={e => setBrand(e.target.value)}></Form.Control>
                        ...
                        <Form.Group controlId="category">
                            ...
                            <Form.Control type="name" placeholder="Enter Category" value={category} onChange={e => setCategory(e.target.value)}></Form.Control>
                        </Form.Group>
